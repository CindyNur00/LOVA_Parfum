...
class ProductDetailScreen extends StatefulWidget {
  ...
  const ProductDetailScreen({Key? key, required this.product, required this.user}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Share.share(
                  'Lihat parfum ini: ${widget.product.name} - Rp${widget.product.price.toStringAsFixed(0)}!'
                      '${widget.product.fragranceDescription ?? ''}\n'
                      'Cek Parfum ${widget.product.name}',
              );
            },
          ),
          IconButton(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Add To Cart', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
                    ),
                  ),
                ],
              ),
  ...
  void _addToCart() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ParfumCart(user: widget.user),
        ),
      );
